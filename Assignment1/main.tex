...
\begin{enumerate}
 ...
 \item{For any three positive real number $a,b$ and $c$ $9(25a^2+b^2)+ 25(c^2-3ac) = 15b(3a+c)$. Then:\\ \null \hfill{[JEE M 2017]}\begin{multicols}{2}
  ...
  \end{multicols}
  \end{enumerate}}
  \item{Let $A$ be the sum of the frst 20 terms and $B$ be the sum of the first 40 terms of the series \sbrak{1^{2} +2\cdot2^{2}+3^{2}+2\cdot4^{2}+5^{2}+2\cdot6^{2}+...} If $B-2A=100$ $\lambda$, then $\lambda$ can be\hfill{[2018]\begin{enumerate}
  \begin{multicols}{2}
