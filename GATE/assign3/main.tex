...
\begin{tikzpicture}
    ...
    \draw[thick] (3,-2.7) arc[start angle=0, end angle=-90, radius=2];
     
    \foreach \angle in {-10,-20,-30,-40,-50,-60,-70,-80,-90} {
        \draw[thick] 
            (1,-2.7) ++(\angle:2) -- ++(\angle:0.3);
    }
    ...
    \node[above right] at (0,-1.5) {\Large Gate};
\end{tikzpicture}
\end{center}
\hfill{[GATE 2011]}
\begin{multicols}{4}
...
\begin{tikzpicture}
    ...
    \draw[thick] (-1.5,0) rectangle (4.5,-0.5);
    \node at (1.5,3) {Water};
    ...
    \draw[thick] (1.5,5) -- (1.3,5.3);
    \draw[thick] (1.5,5) -- (1.7,5.3);
    \draw[thick] (1.3,5.3) -- (1.7,5.3); ;
\end{tikzpicture}
\end{center}
\hfill{[GATE 2011]}
\begin{multicols}{4}
...
\begin{tikzpicture}
    ...
    \draw[thick] (-2,2.5) .. controls (-1.2,1.45) .. (1.75,1); 
    \draw[thick] (-2,-2.5) .. controls (-1.2,-1.45) .. (1.75,-1);
    \draw[->, ultra thick, >=stealth] (-2,0) -- (0,0); 
